...
final class MessageBirdTransportTest extends TransportTestCase
{
    ...
    {
        return (new MessageBirdTransport('testToken', 'testFrom', $client ?: $this->createMock(HttpClientInterface::class)))->setHost('test.host');
    }

    public function toStringProvider(): iterable
    {
        yield ['messagebird://token@default?originator=Imad', $this->createTransport()];
    }
